/*This program is to request an io region*/
...
static int __init my_init(void)
{
    ...
    printk(KERN_INFO"requesting the IO region \n ",iostart,ioend);
...
{
    printk(KERN_INFO "releasing the IO region",iostart,ioend);
...
MODULE_DESCRIPTION("requesting the IO prots");
MODULE_LICENSE("GPL");