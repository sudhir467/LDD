/* Demonstrating character device driver- using Interrupt. In this we will see how
to register the interrupt and how to free interrupt in a character device driver
with bottom half handled by tasklet- static declaration of tasklet*/
...
/* Declarating the tasklet- tasklet name, tasklet_function, data*/
